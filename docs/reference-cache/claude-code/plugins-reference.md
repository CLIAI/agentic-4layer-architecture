<!--
Cached from: https://docs.claude.com/en/docs/claude-code/plugins-reference
...
URL Source: https://docs.claude.com/en/docs/claude-code/plugins-reference

Markdown Content:
# Plugins reference - Claude Code Docs

[Skip to main content](https://docs.claude.com/en/docs/claude-code/plugins-reference#content-area)
...
*   [LSP servers](https://docs.claude.com/en/docs/claude-code/plugins-reference#lsp-servers)
*   [Monitors](https://docs.claude.com/en/docs/claude-code/plugins-reference#monitors)
*   [Themes](https://docs.claude.com/en/docs/claude-code/plugins-reference#themes)
*   [Plugin installation scopes](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-installation-scopes)
...
*   [User configuration](https://docs.claude.com/en/docs/claude-code/plugins-reference#user-configuration)
*   [Channels](https://docs.claude.com/en/docs/claude-code/plugins-reference#channels)
...
*   [Persistent data directory](https://docs.claude.com/en/docs/claude-code/plugins-reference#persistent-data-directory)
*   [Plugin caching and file resolution](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-caching-and-file-resolution)
*   [Path traversal limitations](https://docs.claude.com/en/docs/claude-code/plugins-reference#path-traversal-limitations)
*   [Working with external dependencies](https://docs.claude.com/en/docs/claude-code/plugins-reference#working-with-external-dependencies)
...
*   [CLI commands reference](https://docs.claude.com/en/docs/claude-code/plugins-reference#cli-commands-reference)
*   [plugin install](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-install)
*   [plugin uninstall](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-uninstall)
*   [plugin enable](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-enable)
*   [plugin disable](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-disable)
*   [plugin update](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-update)
*   [plugin list](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-list)
*   [plugin tag](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-tag)
...
*   [Example error messages](https://docs.claude.com/en/docs/claude-code/plugins-reference#example-error-messages)
*   [Hook troubleshooting](https://docs.claude.com/en/docs/claude-code/plugins-reference#hook-troubleshooting)
*   [MCP server troubleshooting](https://docs.claude.com/en/docs/claude-code/plugins-reference#mcp-server-troubleshooting)
*   [Directory structure mistakes](https://docs.claude.com/en/docs/claude-code/plugins-reference#directory-structure-mistakes)
...
*   [See also](https://docs.claude.com/en/docs/claude-code/plugins-reference#see-also)
...
Looking to install plugins? See [Discover and install plugins](https://docs.claude.com/docs/en/discover-plugins). For creating plugins, see [Plugins](https://docs.claude.com/docs/en/plugins). For distributing plugins, see [Plugin marketplaces](https://docs.claude.com/docs/en/plugin-marketplaces).
...
## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-components-reference)
...
For complete details, see [Skills](https://docs.claude.com/docs/en/skills).
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#agents)
...
For complete details, see [Subagents](https://docs.claude.com/docs/en/sub-agents).
...
Plugin hooks respond to the same lifecycle events as [user-defined hooks](https://docs.claude.com/docs/en/hooks):
...
*   `mcp_tool`: call a tool on a configured [MCP server](https://docs.claude.com/docs/en/mcp)
*   `prompt`: evaluate a prompt with an LLM (uses `$ARGUMENTS` placeholder for context)
*   `agent`: run an agentic verifier with tools for complex verification tasks

### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#mcp-servers)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#lsp-servers)
...
The `command` value supports the same [variable substitutions](https://docs.claude.com/en/docs/claude-code/plugins-reference#environment-variables) as MCP and LSP server configs: `${CLAUDE_PLUGIN_ROOT}`, `${CLAUDE_PLUGIN_DATA}`, `${user_config.*}`, and any `${ENV_VAR}` from the environment. Prefix the command with `cd "${CLAUDE_PLUGIN_ROOT}" &&` if the script needs to run from the plugin’s own directory.Disabling a plugin mid-session does not stop monitors that are already running. They stop when the session ends.
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#themes)
...
## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-installation-scopes)
...
| `managed` | [Managed settings](https://docs.claude.com/docs/en/settings#settings-files) | Managed plugins (read-only, update only) |

Plugins use the same scope system as other Claude Code configurations. For installation instructions and scope flags, see [Install plugins](https://docs.claude.com/docs/en/discover-plugins#install-plugins). For a complete explanation of scopes, see [Configuration scopes](https://docs.claude.com/docs/en/settings#configuration-scopes).

* * *

## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-manifest-schema)

Plugin manifest schema

The `.claude-plugin/plugin.json` file defines your plugin’s metadata and configuration. This section documents all supported fields and options.The manifest is optional. If omitted, Claude Code auto-discovers components in [default locations](https://docs.claude.com/en/docs/claude-code/plugins-reference#file-locations-reference) and derives the plugin name from the directory name. Use a manifest when you need to provide metadata or custom component paths.
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#complete-schema)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#required-fields)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#component-path-fields)
...
| `themes` | string|array | Color theme files/directories (replaces default `themes/`). See [Themes](https://docs.claude.com/en/docs/claude-code/plugins-reference#themes) | `"./themes/"` |
...
| `monitors` | string|array | Background [Monitor](https://docs.claude.com/docs/en/tools-reference#monitor-tool) configurations that start automatically when the plugin is active. See [Monitors](https://docs.claude.com/en/docs/claude-code/plugins-reference#monitors) | `"./monitors.json"` |
| `userConfig` | object | User-configurable values prompted at enable time. See [User configuration](https://docs.claude.com/en/docs/claude-code/plugins-reference#user-configuration) | See below |
| `channels` | array | Channel declarations for message injection (Telegram, Slack, Discord style). See [Channels](https://docs.claude.com/en/docs/claude-code/plugins-reference#channels) | See below |
| `dependencies` | array | Other plugins this plugin requires, optionally with semver version constraints. See [Constrain plugin dependency versions](https://docs.claude.com/docs/en/plugin-dependencies) | `[{ "name": "secrets-vault", "version": "~2.1.0" }]` |

### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#user-configuration)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#channels)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#path-behavior-rules)

Path behavior rules

For `skills`, `commands`, `agents`, `outputStyles`, `themes`, and `monitors`, a custom path replaces the default. If the manifest specifies `skills`, the default `skills/` directory is not scanned; if it specifies `monitors`, the default `monitors/monitors.json` is not loaded. [Hooks](https://docs.claude.com/en/docs/claude-code/plugins-reference#hooks), [MCP servers](https://docs.claude.com/en/docs/claude-code/plugins-reference#mcp-servers), and [LSP servers](https://docs.claude.com/en/docs/claude-code/plugins-reference#lsp-servers) have different semantics for handling multiple sources.
...
#### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#persistent-data-directory)
...
The data directory is deleted automatically when you uninstall the plugin from the last scope where it is installed. The `/plugin` interface shows the directory size and prompts before deleting. The CLI deletes by default; pass [`--keep-data`](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-uninstall) to preserve it.

* * *

## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-caching-and-file-resolution)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#path-traversal-limitations)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#working-with-external-dependencies)
...
## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-directory-structure)

Plugin directory structure

### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#standard-plugin-layout)
...
| **Settings** | `settings.json` | Default configuration applied when the plugin is enabled. Only the [`agent`](https://docs.claude.com/docs/en/sub-agents) and [`subagentStatusLine`](https://docs.claude.com/docs/en/statusline#subagent-status-lines) keys are currently supported |

* * *

## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#cli-commands-reference)

CLI commands reference

Claude Code provides CLI commands for non-interactive plugin management, useful for scripting and automation.
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-install)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-uninstall)
...
| `--keep-data` | Preserve the plugin’s [persistent data directory](https://docs.claude.com/en/docs/claude-code/plugins-reference#persistent-data-directory) |  |
| `-h, --help` | Display help for command |  |
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-enable)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-disable)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-update)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-list)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#plugin-tag)

plugin tag

Create a release git tag for the plugin in the current directory. Run from inside the plugin’s folder. See [Tag plugin releases](https://docs.claude.com/docs/en/plugin-dependencies#tag-plugin-releases-for-version-resolution).
...
## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#debugging-and-development-tools)

Debugging and development tools

### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#debugging-commands)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#common-issues)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#example-error-messages)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#hook-troubleshooting)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#mcp-server-troubleshooting)
...
### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#directory-structure-mistakes)
...
## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#distribution-and-versioning-reference)

Distribution and versioning reference

### [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#version-management)
...
## [​](https://docs.claude.com/en/docs/claude-code/plugins-reference#see-also)

See also

*   [Plugins](https://docs.claude.com/docs/en/plugins) - Tutorials and practical usage
*   [Plugin marketplaces](https://docs.claude.com/docs/en/plugin-marketplaces) - Creating and managing marketplaces
*   [Skills](https://docs.claude.com/docs/en/skills) - Skill development details
*   [Subagents](https://docs.claude.com/docs/en/sub-agents) - Agent configuration and capabilities
*   [Hooks](https://docs.claude.com/docs/en/hooks) - Event handling and automation
*   [MCP](https://docs.claude.com/docs/en/mcp) - External tool integration
*   [Settings](https://docs.claude.com/docs/en/settings) - Configuration options for plugins

Was this page helpful?

Yes No

[Hooks reference](https://docs.claude.com/docs/en/hooks)[Channels reference](https://docs.claude.com/docs/en/channels-reference)
...
[Privacy choices](https://docs.claude.com/en/docs/claude-code/plugins-reference#)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
