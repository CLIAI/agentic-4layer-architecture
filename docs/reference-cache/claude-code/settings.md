<!--
Cached from: https://docs.claude.com/en/docs/claude-code/settings
...
URL Source: https://docs.claude.com/en/docs/claude-code/settings

Markdown Content:
# Claude Code settings - Claude Code Docs

[Skip to main content](https://docs.claude.com/en/docs/claude-code/settings#content-area)
...
*   [Settings](https://docs.claude.com/docs/en/settings)
*   [Permissions](https://docs.claude.com/docs/en/permissions)
*   [Sandboxing](https://docs.claude.com/docs/en/sandboxing)

##### Model and responses

*   [Model configuration](https://docs.claude.com/docs/en/model-config)
*   [Speed up responses with fast mode](https://docs.claude.com/docs/en/fast-mode)
*   [Output styles](https://docs.claude.com/docs/en/output-styles)

##### Interface

*   [Terminal configuration](https://docs.claude.com/docs/en/terminal-config)
*   [Fullscreen rendering](https://docs.claude.com/docs/en/fullscreen)
*   [Voice dictation](https://docs.claude.com/docs/en/voice-dictation)
*   [Customize status line](https://docs.claude.com/docs/en/statusline)
*   [Customize keyboard shortcuts](https://docs.claude.com/docs/en/keybindings)

On this page

*   [Configuration scopes](https://docs.claude.com/en/docs/claude-code/settings#configuration-scopes)
*   [Available scopes](https://docs.claude.com/en/docs/claude-code/settings#available-scopes)
*   [When to use each scope](https://docs.claude.com/en/docs/claude-code/settings#when-to-use-each-scope)
*   [How scopes interact](https://docs.claude.com/en/docs/claude-code/settings#how-scopes-interact)
*   [What uses scopes](https://docs.claude.com/en/docs/claude-code/settings#what-uses-scopes)
...
*   [Global config settings](https://docs.claude.com/en/docs/claude-code/settings#global-config-settings)
*   [Worktree settings](https://docs.claude.com/en/docs/claude-code/settings#worktree-settings)
*   [Permission settings](https://docs.claude.com/en/docs/claude-code/settings#permission-settings)
*   [Permission rule syntax](https://docs.claude.com/en/docs/claude-code/settings#permission-rule-syntax)
*   [Sandbox settings](https://docs.claude.com/en/docs/claude-code/settings#sandbox-settings)
*   [Sandbox path prefixes](https://docs.claude.com/en/docs/claude-code/settings#sandbox-path-prefixes)
*   [Attribution settings](https://docs.claude.com/en/docs/claude-code/settings#attribution-settings)
*   [File suggestion settings](https://docs.claude.com/en/docs/claude-code/settings#file-suggestion-settings)
*   [Hook configuration](https://docs.claude.com/en/docs/claude-code/settings#hook-configuration)
*   [Settings precedence](https://docs.claude.com/en/docs/claude-code/settings#settings-precedence)
*   [Verify active settings](https://docs.claude.com/en/docs/claude-code/settings#verify-active-settings)
...
*   [System prompt](https://docs.claude.com/en/docs/claude-code/settings#system-prompt)
...
*   [Plugin configuration](https://docs.claude.com/en/docs/claude-code/settings#plugin-configuration)
*   [Plugin settings](https://docs.claude.com/en/docs/claude-code/settings#plugin-settings)
*   [enabledPlugins](https://docs.claude.com/en/docs/claude-code/settings#enabledplugins)
*   [extraKnownMarketplaces](https://docs.claude.com/en/docs/claude-code/settings#extraknownmarketplaces)
*   [strictKnownMarketplaces](https://docs.claude.com/en/docs/claude-code/settings#strictknownmarketplaces)
*   [Managing plugins](https://docs.claude.com/en/docs/claude-code/settings#managing-plugins)
...
## [​](https://docs.claude.com/en/docs/claude-code/settings#configuration-scopes)

Configuration scopes

Claude Code uses a **scope system** to determine where configurations apply and who they’re shared with. Understanding scopes helps you decide how to configure Claude Code for personal use, team collaboration, or enterprise deployment.
### [​](https://docs.claude.com/en/docs/claude-code/settings#available-scopes)
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#when-to-use-each-scope)
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#how-scopes-interact)
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#what-uses-scopes)
...
*   **Managed settings**: For organizations that need centralized control, Claude Code supports multiple delivery mechanisms for managed settings. All use the same JSON format and cannot be overridden by user or project settings:
    *   **Server-managed settings**: delivered from Anthropic’s servers via the Claude.ai admin console. See [server-managed settings](https://docs.claude.com/docs/en/server-managed-settings).
...
See [managed settings](https://docs.claude.com/docs/en/permissions#managed-only-settings) and [Managed MCP configuration](https://docs.claude.com/docs/en/mcp#managed-mcp-configuration) for details.This [repository](https://github.com/anthropics/claude-code/tree/main/examples/mdm) includes starter deployment templates for Jamf, Iru (Kandji), Intune, and Group Policy. Use these as starting points and adjust them to fit your needs.

Managed deployments can also restrict **plugin marketplace additions** using `strictKnownMarketplaces`. For more information, see [Managed marketplace restrictions](https://docs.claude.com/docs/en/plugin-marketplaces#managed-marketplace-restrictions).

*   **Other configuration** is stored in `~/.claude.json`. This file contains your OAuth session, [MCP server](https://docs.claude.com/docs/en/mcp) configurations for user and local scopes, per-project state (allowed tools, trust settings), and various caches. Project-scoped MCP servers are stored separately in `.mcp.json`.
...
| --- | --- | --- |
| `agent` | Run the main thread as a named subagent. Applies that subagent’s system prompt, tool restrictions, and model. See [Invoke subagents explicitly](https://docs.claude.com/docs/en/sub-agents#invoke-subagents-explicitly) | `"code-reviewer"` |
| `allowedChannelPlugins` | (Managed settings only) Allowlist of channel plugins that may push messages. Replaces the default Anthropic allowlist when set. Undefined = fall back to the default, empty array = block all channel plugins. Requires `channelsEnabled: true`. See [Restrict which channel plugins can run](https://docs.claude.com/docs/en/channels#restrict-which-channel-plugins-can-run) | `[{ "marketplace": "claude-plugins-official", "plugin": "telegram" }]` |
| `allowedHttpHookUrls` | Allowlist of URL patterns that HTTP hooks may target. Supports `*` as a wildcard. When set, hooks with non-matching URLs are blocked. Undefined = no restriction, empty array = block all HTTP hooks. Arrays merge across settings sources. See [Hook configuration](https://docs.claude.com/en/docs/claude-code/settings#hook-configuration) | `["https://hooks.example.com/*"]` |
| `allowedMcpServers` | When set in managed-settings.json, allowlist of MCP servers users can configure. Undefined = no restrictions, empty array = lockdown. Applies to all scopes. Denylist takes precedence. See [Managed MCP configuration](https://docs.claude.com/docs/en/mcp#managed-mcp-configuration) | `[{ "serverName": "github" }]` |
| `allowManagedHooksOnly` | (Managed settings only) Only managed hooks, SDK hooks, and hooks from plugins force-enabled in managed settings `enabledPlugins` are loaded. User, project, and all other plugin hooks are blocked. See [Hook configuration](https://docs.claude.com/en/docs/claude-code/settings#hook-configuration) | `true` |
...
| `allowManagedPermissionRulesOnly` | (Managed settings only) Prevent user and project settings from defining `allow`, `ask`, or `deny` permission rules. Only rules in managed settings apply. See [Managed-only settings](https://docs.claude.com/docs/en/permissions#managed-only-settings) | `true` |
| `alwaysThinkingEnabled` | Enable [extended thinking](https://docs.claude.com/docs/en/common-workflows#use-extended-thinking-thinking-mode) by default for all sessions. Typically configured via the `/config` command rather than editing directly | `true` |
| `apiKeyHelper` | Custom script, to be executed in `/bin/sh`, to generate an auth value. This value will be sent as `X-Api-Key` and `Authorization: Bearer` headers for model requests | `/bin/generate_temp_api_key.sh` |
| `attribution` | Customize attribution for git commits and pull requests. See [Attribution settings](https://docs.claude.com/en/docs/claude-code/settings#attribution-settings) | `{"commit": "🤖 Generated with Claude Code", "pr": ""}` |
| `autoMemoryDirectory` | Custom directory for [auto memory](https://docs.claude.com/docs/en/memory#storage-location) storage. Accepts `~/`-expanded paths. Not accepted in project settings (`.claude/settings.json`) to prevent shared repos from redirecting memory writes to sensitive locations. Accepted from policy, local, and user settings | `"~/my-memory-dir"` |
...
| `autoScrollEnabled` | In [fullscreen rendering](https://docs.claude.com/docs/en/fullscreen), follow new output to the bottom of the conversation. Default: `true`. Appears in `/config` as **Auto-scroll**. Permission prompts still scroll into view when this is off | `false` |
...
| `availableModels` | Restrict which models users can select via `/model`, `--model`, or `ANTHROPIC_MODEL`. Does not affect the Default option. See [Restrict model selection](https://docs.claude.com/docs/en/model-config#restrict-model-selection) | `["sonnet", "haiku"]` |
| `awaySummaryEnabled` | Show a one-line session recap when you return to the terminal after a few minutes away. Set to `false` or turn off Session recap in `/config` to disable. Same as [`CLAUDE_CODE_ENABLE_AWAY_SUMMARY`](https://docs.claude.com/docs/en/env-vars) | `true` |
| `awsAuthRefresh` | Custom script that modifies the `.aws` directory (see [advanced credential configuration](https://docs.claude.com/docs/en/amazon-bedrock#advanced-credential-configuration)) | `aws sso login --profile myprofile` |
| `awsCredentialExport` | Custom script that outputs JSON with AWS credentials (see [advanced credential configuration](https://docs.claude.com/docs/en/amazon-bedrock#advanced-credential-configuration)) | `/bin/generate_aws_grant.sh` |
...
| `channelsEnabled` | (Managed settings only) Allow [channels](https://docs.claude.com/docs/en/channels) for Team and Enterprise users. Unset or `false` blocks channel message delivery regardless of what users pass to `--channels` | `true` |
| `cleanupPeriodDays` | Session files older than this period are deleted at startup (default: 30 days, minimum 1). Setting to `0` is rejected with a validation error. Also controls the age cutoff for automatic removal of [orphaned subagent worktrees](https://docs.claude.com/docs/en/common-workflows#worktree-cleanup) at startup. To disable transcript writes entirely, set the [`CLAUDE_CODE_SKIP_PROMPT_HISTORY`](https://docs.claude.com/docs/en/env-vars) environment variable, or in non-interactive mode (`-p`) use the `--no-session-persistence` flag or the `persistSession: false` SDK option. | `20` |
| `companyAnnouncements` | Announcement to display to users at startup. If multiple announcements are provided, they will be cycled through at random. | `["Welcome to Acme Corp! Review our code guidelines at docs.acme.com"]` |
| `defaultShell` | Default shell for input-box `!` commands. Accepts `"bash"` (default) or `"powershell"`. Setting `"powershell"` routes interactive `!` commands through PowerShell on Windows. Requires `CLAUDE_CODE_USE_POWERSHELL_TOOL=1`. See [PowerShell tool](https://docs.claude.com/docs/en/tools-reference#powershell-tool) | `"powershell"` |
...
| `disableAllHooks` | Disable all [hooks](https://docs.claude.com/docs/en/hooks) and any custom [status line](https://docs.claude.com/docs/en/statusline) | `true` |
| `disableAutoMode` | Set to `"disable"` to prevent [auto mode](https://docs.claude.com/docs/en/permission-modes#eliminate-prompts-with-auto-mode) from being activated. Removes `auto` from the `Shift+Tab` cycle and rejects `--permission-mode auto` at startup. Most useful in [managed settings](https://docs.claude.com/docs/en/permissions#managed-settings) where users cannot override it | `"disable"` |
...
| `feedbackSurveyRate` | Probability (0–1) that the [session quality survey](https://docs.claude.com/docs/en/data-usage#session-quality-surveys) appears when eligible. Set to `0` to suppress entirely. Useful when using Bedrock, Vertex, or Foundry where the default sample rate does not apply | `0.05` |
| `fileSuggestion` | Configure a custom script for `@` file autocomplete. See [File suggestion settings](https://docs.claude.com/en/docs/claude-code/settings#file-suggestion-settings) | `{"type": "command", "command": "~/.claude/file-suggestion.sh"}` |
...
| `language` | Configure Claude’s preferred response language (e.g., `"japanese"`, `"spanish"`, `"french"`). Claude will respond in this language by default. Also sets the [voice dictation](https://docs.claude.com/docs/en/voice-dictation#change-the-dictation-language) language | `"japanese"` |
| `minimumVersion` | Floor that prevents background auto-updates and `claude update` from installing a version below this one. Switching from the `"latest"` channel to `"stable"` via `/config` prompts you to stay on the current version or allow the downgrade. Choosing to stay sets this value. Also useful in [managed settings](https://docs.claude.com/docs/en/permissions#managed-settings) to pin an organization-wide minimum | `"2.1.100"` |
| `model` | Override the default model to use for Claude Code | `"claude-sonnet-4-6"` |
| `modelOverrides` | Map Anthropic model IDs to provider-specific model IDs such as Bedrock inference profile ARNs. Each model picker entry uses its mapped value when calling the provider API. See [Override model IDs per version](https://docs.claude.com/docs/en/model-config#override-model-ids-per-version) | `{"claude-opus-4-6": "arn:aws:bedrock:..."}` |
| `otelHeadersHelper` | Script to generate dynamic OpenTelemetry headers. Runs at startup and periodically (see [Dynamic headers](https://docs.claude.com/docs/en/monitoring-usage#dynamic-headers)) | `/bin/generate_otel_headers.sh` |
| `outputStyle` | Configure an output style to adjust the system prompt. See [output styles documentation](https://docs.claude.com/docs/en/output-styles) | `"Explanatory"` |
...
| `showThinkingSummaries` | Show [extended thinking](https://docs.claude.com/docs/en/common-workflows#use-extended-thinking-thinking-mode) summaries in interactive sessions. When unset or `false` (default in interactive mode), thinking blocks are redacted by the API and shown as a collapsed stub. Redaction only changes what you see, not what the model generates: to reduce thinking spend, [lower the budget or disable thinking](https://docs.claude.com/docs/en/common-workflows#use-extended-thinking-thinking-mode) instead. Non-interactive mode (`-p`) and SDK callers always receive summaries regardless of this setting | `true` |
...
| `sshConfigs` | SSH connections to show in the [Desktop](https://docs.claude.com/docs/en/desktop#pre-configure-ssh-connections-for-your-team) environment dropdown. Each entry requires `id`, `name`, and `sshHost`; `sshPort`, `sshIdentityFile`, and `startDirectory` are optional. When set in managed settings, connections are read-only for users. Read from managed and user settings only | `[{"id": "dev-vm", "name": "Dev VM", "sshHost": "user@dev.example.com"}]` |
| `statusLine` | Configure a custom status line to display context. See [`statusLine` documentation](https://docs.claude.com/docs/en/statusline) | `{"type": "command", "command": "~/.claude/statusline.sh"}` |
| `strictKnownMarketplaces` | (Managed settings only) Allowlist of plugin marketplace sources. Undefined = no restrictions, empty array = lockdown. Enforced on marketplace add and on plugin install, update, refresh, and auto-update, so a marketplace added before the policy was set cannot be used to fetch plugins. See [Managed marketplace restrictions](https://docs.claude.com/docs/en/plugin-marketplaces#managed-marketplace-restrictions) | `[{ "source": "github", "repo": "acme-corp/plugins" }]` |
| `teammateMode` | How [agent team](https://docs.claude.com/docs/en/agent-teams) teammates display: `auto` (picks split panes in tmux or iTerm2, in-process otherwise), `in-process`, or `tmux`. See [choose a display mode](https://docs.claude.com/docs/en/agent-teams#choose-a-display-mode) | `"in-process"` |
...
| `tui` | Terminal UI renderer. Use `"fullscreen"` for the flicker-free [alt-screen renderer](https://docs.claude.com/docs/en/fullscreen) with virtualized scrollback. Use `"default"` for the classic main-screen renderer. Set via `/tui` | `"fullscreen"` |
...
| `voice` | [Voice dictation](https://docs.claude.com/docs/en/voice-dictation) settings: `enabled` turns dictation on, `mode` selects `"hold"` or `"tap"`, and `autoSubmit` sends the prompt on key release in hold mode. Written automatically when you run `/voice`. Requires a Claude.ai account | `{ "enabled": true, "mode": "tap" }` |
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#global-config-settings)
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#worktree-settings)
...
To copy gitignored files like `.env` into new worktrees, use a [`.worktreeinclude` file](https://docs.claude.com/docs/en/common-workflows#copy-gitignored-files-to-worktrees) in your project root instead of a setting.
### [​](https://docs.claude.com/en/docs/claude-code/settings#permission-settings)

Permission settings

| Keys | Description | Example |
| --- | --- | --- |
| `allow` | Array of permission rules to allow tool use. See [Permission rule syntax](https://docs.claude.com/en/docs/claude-code/settings#permission-rule-syntax) below for pattern matching details | `[ "Bash(git diff *)" ]` |
| `ask` | Array of permission rules to ask for confirmation upon tool use. See [Permission rule syntax](https://docs.claude.com/en/docs/claude-code/settings#permission-rule-syntax) below | `[ "Bash(git push *)" ]` |
| `deny` | Array of permission rules to deny tool use. Use this to exclude sensitive files from Claude Code access. See [Permission rule syntax](https://docs.claude.com/en/docs/claude-code/settings#permission-rule-syntax) and [Bash permission limitations](https://docs.claude.com/docs/en/permissions#tool-specific-permission-rules) | `[ "WebFetch", "Bash(curl *)", "Read(./.env)", "Read(./secrets/**)" ]` |
| `additionalDirectories` | Additional [working directories](https://docs.claude.com/docs/en/permissions#working-directories) for file access. Most `.claude/` configuration is [not discovered](https://docs.claude.com/docs/en/permissions#additional-directories-grant-file-access-not-configuration) from these directories | `[ "../docs/" ]` |
| `defaultMode` | Default [permission mode](https://docs.claude.com/docs/en/permission-modes) when opening Claude Code. Valid values: `default`, `acceptEdits`, `plan`, `auto`, `dontAsk`, `bypassPermissions`. The `--permission-mode` CLI flag overrides this setting for a single session | `"acceptEdits"` |
| `disableBypassPermissionsMode` | Set to `"disable"` to prevent `bypassPermissions` mode from being activated. This disables the `--dangerously-skip-permissions` command-line flag. Typically placed in [managed settings](https://docs.claude.com/docs/en/permissions#managed-settings) to enforce organizational policy, but works from any scope | `"disable"` |
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#permission-rule-syntax)
...
For the complete rule syntax reference, including wildcard behavior, tool-specific patterns for Read, Edit, WebFetch, MCP, and Agent rules, and security limitations of Bash patterns, see [Permission rule syntax](https://docs.claude.com/docs/en/permissions#permission-rule-syntax).
### [​](https://docs.claude.com/en/docs/claude-code/settings#sandbox-settings)

Sandbox settings

Configure advanced sandboxing behavior. Sandboxing isolates bash commands from your filesystem and network. See [Sandboxing](https://docs.claude.com/docs/en/sandboxing) for details.
...
#### [​](https://docs.claude.com/en/docs/claude-code/settings#sandbox-path-prefixes)
...
The older `//path` prefix for absolute paths still works. If you previously used single-slash `/path` expecting project-relative resolution, switch to `./path`. This syntax differs from [Read and Edit permission rules](https://docs.claude.com/docs/en/permissions#read-and-edit), which use `//path` for absolute and `/path` for project-relative. Sandbox filesystem paths use standard conventions: `/tmp/build` is an absolute path.**Configuration example:**
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#attribution-settings)
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#file-suggestion-settings)
...
The command runs with the same environment variables as [hooks](https://docs.claude.com/docs/en/hooks), including `CLAUDE_PROJECT_DIR`. It receives JSON via stdin with a `query` field:
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#settings-precedence)

Settings precedence

Settings apply in order of precedence. From highest to lowest:
1.   **Managed settings** ([server-managed](https://docs.claude.com/docs/en/server-managed-settings), [MDM/OS-level policies](https://docs.claude.com/en/docs/claude-code/settings#configuration-scopes), or [managed settings](https://docs.claude.com/docs/en/settings#settings-files))
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#verify-active-settings)
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#key-points-about-the-configuration-system)
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#system-prompt)
...
## [​](https://docs.claude.com/en/docs/claude-code/settings#subagent-configuration)
...
Subagent files define specialized AI assistants with custom prompts and tool permissions. Learn more about creating and using subagents in the [subagents documentation](https://docs.claude.com/docs/en/sub-agents).
## [​](https://docs.claude.com/en/docs/claude-code/settings#plugin-configuration)
...
### [​](https://docs.claude.com/en/docs/claude-code/settings#plugin-settings)
...
#### [​](https://docs.claude.com/en/docs/claude-code/settings#enabledplugins)
...
#### [​](https://docs.claude.com/en/docs/claude-code/settings#extraknownmarketplaces)
...
#### [​](https://docs.claude.com/en/docs/claude-code/settings#strictknownmarketplaces)

`strictKnownMarketplaces`

**Managed settings only**: Controls which plugin marketplaces users are allowed to add and install plugins from. This setting can only be configured in [managed settings](https://docs.claude.com/docs/en/settings#settings-files) and provides administrators with strict control over marketplace sources.**Managed settings file locations**:
...
See [Managed marketplace restrictions](https://docs.claude.com/docs/en/plugin-marketplaces#managed-marketplace-restrictions) for user-facing documentation.
### [​](https://docs.claude.com/en/docs/claude-code/settings#managing-plugins)
...
## [​](https://docs.claude.com/en/docs/claude-code/settings#see-also)

See also

*   [Permissions](https://docs.claude.com/docs/en/permissions): permission system, rule syntax, tool-specific patterns, and managed policies
*   [Authentication](https://docs.claude.com/docs/en/authentication): set up user access to Claude Code
*   [Debug your configuration](https://docs.claude.com/docs/en/debug-your-config): diagnose why a setting, hook, or MCP server isn’t taking effect
*   [Troubleshooting](https://docs.claude.com/docs/en/troubleshooting): installation, authentication, and platform issues
...
[Privacy choices](https://docs.claude.com/en/docs/claude-code/settings#)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
