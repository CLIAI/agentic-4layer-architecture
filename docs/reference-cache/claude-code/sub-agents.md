<!--
Cached from: https://docs.claude.com/en/docs/claude-code/sub-agents
...
URL Source: https://docs.claude.com/en/docs/claude-code/sub-agents

Markdown Content:
# Create custom subagents - Claude Code Docs

[Skip to main content](https://docs.claude.com/en/docs/claude-code/sub-agents#content-area)
...
*   [Create custom subagents](https://docs.claude.com/docs/en/sub-agents)
*   [Run agent teams](https://docs.claude.com/docs/en/agent-teams)

##### Tools and plugins

*   [Model Context Protocol (MCP)](https://docs.claude.com/docs/en/mcp)
*   [Discover and install prebuilt plugins](https://docs.claude.com/docs/en/discover-plugins)
*   [Create plugins](https://docs.claude.com/docs/en/plugins)
*   [Extend Claude with skills](https://docs.claude.com/docs/en/skills)

##### Automation

*   [Automate with hooks](https://docs.claude.com/docs/en/hooks-guide)
*   [Push external events to Claude](https://docs.claude.com/docs/en/channels)
*   [Run prompts on a schedule](https://docs.claude.com/docs/en/scheduled-tasks)
*   [Programmatic usage](https://docs.claude.com/docs/en/headless)

##### Troubleshooting

*   [Troubleshooting](https://docs.claude.com/docs/en/troubleshooting)
*   [Debug configuration](https://docs.claude.com/docs/en/debug-your-config)
*   [Error reference](https://docs.claude.com/docs/en/errors)

On this page

*   [Built-in subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#built-in-subagents)
*   [Quickstart: create your first subagent](https://docs.claude.com/en/docs/claude-code/sub-agents#quickstart-create-your-first-subagent)
*   [Configure subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#configure-subagents)
*   [Use the /agents command](https://docs.claude.com/en/docs/claude-code/sub-agents#use-the-%2Fagents-command)
*   [Choose the subagent scope](https://docs.claude.com/en/docs/claude-code/sub-agents#choose-the-subagent-scope)
*   [Write subagent files](https://docs.claude.com/en/docs/claude-code/sub-agents#write-subagent-files)
*   [Supported frontmatter fields](https://docs.claude.com/en/docs/claude-code/sub-agents#supported-frontmatter-fields)
*   [Choose a model](https://docs.claude.com/en/docs/claude-code/sub-agents#choose-a-model)
*   [Control subagent capabilities](https://docs.claude.com/en/docs/claude-code/sub-agents#control-subagent-capabilities)
*   [Available tools](https://docs.claude.com/en/docs/claude-code/sub-agents#available-tools)
*   [Restrict which subagents can be spawned](https://docs.claude.com/en/docs/claude-code/sub-agents#restrict-which-subagents-can-be-spawned)
*   [Scope MCP servers to a subagent](https://docs.claude.com/en/docs/claude-code/sub-agents#scope-mcp-servers-to-a-subagent)
*   [Permission modes](https://docs.claude.com/en/docs/claude-code/sub-agents#permission-modes)
*   [Preload skills into subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#preload-skills-into-subagents)
*   [Enable persistent memory](https://docs.claude.com/en/docs/claude-code/sub-agents#enable-persistent-memory)
*   [Conditional rules with hooks](https://docs.claude.com/en/docs/claude-code/sub-agents#conditional-rules-with-hooks)
*   [Disable specific subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#disable-specific-subagents)
*   [Define hooks for subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#define-hooks-for-subagents)
*   [Hooks in subagent frontmatter](https://docs.claude.com/en/docs/claude-code/sub-agents#hooks-in-subagent-frontmatter)
*   [Project-level hooks for subagent events](https://docs.claude.com/en/docs/claude-code/sub-agents#project-level-hooks-for-subagent-events)
*   [Work with subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#work-with-subagents)
*   [Understand automatic delegation](https://docs.claude.com/en/docs/claude-code/sub-agents#understand-automatic-delegation)
*   [Invoke subagents explicitly](https://docs.claude.com/en/docs/claude-code/sub-agents#invoke-subagents-explicitly)
*   [Run subagents in foreground or background](https://docs.claude.com/en/docs/claude-code/sub-agents#run-subagents-in-foreground-or-background)
*   [Common patterns](https://docs.claude.com/en/docs/claude-code/sub-agents#common-patterns)
*   [Isolate high-volume operations](https://docs.claude.com/en/docs/claude-code/sub-agents#isolate-high-volume-operations)
*   [Run parallel research](https://docs.claude.com/en/docs/claude-code/sub-agents#run-parallel-research)
*   [Chain subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#chain-subagents)
*   [Choose between subagents and main conversation](https://docs.claude.com/en/docs/claude-code/sub-agents#choose-between-subagents-and-main-conversation)
*   [Manage subagent context](https://docs.claude.com/en/docs/claude-code/sub-agents#manage-subagent-context)
*   [Resume subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#resume-subagents)
*   [Auto-compaction](https://docs.claude.com/en/docs/claude-code/sub-agents#auto-compaction)
*   [Fork the current conversation](https://docs.claude.com/en/docs/claude-code/sub-agents#fork-the-current-conversation)
*   [Observe and steer running forks](https://docs.claude.com/en/docs/claude-code/sub-agents#observe-and-steer-running-forks)
*   [How forks differ from named subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#how-forks-differ-from-named-subagents)
*   [Limitations](https://docs.claude.com/en/docs/claude-code/sub-agents#limitations)
...
*   [Database query validator](https://docs.claude.com/en/docs/claude-code/sub-agents#database-query-validator)
*   [Next steps](https://docs.claude.com/en/docs/claude-code/sub-agents#next-steps)
...
Subagents are specialized AI assistants that handle specific types of tasks. Use one when a side task would flood your main conversation with search results, logs, or file contents you won’t reference again: the subagent does that work in its own context and returns only the summary. Define a custom subagent when you keep spawning the same kind of worker with the same instructions.Each subagent runs in its own context window with a custom system prompt, specific tool access, and independent permissions. When Claude encounters a task that matches a subagent’s description, it delegates to that subagent, which works independently and returns results. To see the context savings in practice, the [context window visualization](https://docs.claude.com/docs/en/context-window) walks through a session where a subagent handles research in its own separate window.

If you need multiple agents working in parallel and communicating with each other, see [agent teams](https://docs.claude.com/docs/en/agent-teams) instead. Subagents work within a single session; agent teams coordinate across separate sessions.
...
*   [Built-in subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#built-in-subagents)
*   [How to create your own](https://docs.claude.com/en/docs/claude-code/sub-agents#quickstart-create-your-first-subagent)
*   [Full configuration options](https://docs.claude.com/en/docs/claude-code/sub-agents#configure-subagents)
*   [Patterns for working with subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#work-with-subagents)
*   [Forked subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#fork-the-current-conversation)
*   [Example subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#example-subagents)

## [​](https://docs.claude.com/en/docs/claude-code/sub-agents#built-in-subagents)
...
A research agent used during [plan mode](https://docs.claude.com/docs/en/common-workflows#use-plan-mode-for-safe-code-analysis) to gather context before presenting a plan.
...
## [​](https://docs.claude.com/en/docs/claude-code/sub-agents#quickstart-create-your-first-subagent)

Quickstart: create your first subagent

Subagents are defined in Markdown files with YAML frontmatter. You can [create them manually](https://docs.claude.com/en/docs/claude-code/sub-agents#write-subagent-files) or use the `/agents` command.This walkthrough guides you through creating a user-level subagent with the `/agents` command. The subagent reviews code and suggests improvements for the codebase.
...
## [​](https://docs.claude.com/en/docs/claude-code/sub-agents#configure-subagents)

Configure subagents

### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#use-the-/agents-command)
...
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#choose-the-subagent-scope)
...
| --- | --- | --- | --- |
| Managed settings | Organization-wide | 1 (highest) | Deployed via [managed settings](https://docs.claude.com/docs/en/settings) |
...
Subagent definitions from any of these scopes are also available to [agent teams](https://docs.claude.com/docs/en/agent-teams#use-subagent-definitions-for-teammates): when spawning a teammate, you can reference a subagent type and the teammate uses its `tools` and `model`, with the definition’s body appended to the teammate’s system prompt as additional instructions. See [agent teams](https://docs.claude.com/docs/en/agent-teams#use-subagent-definitions-for-teammates) for which frontmatter fields apply on that path.
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#write-subagent-files)
...
| `tools` | No | [Tools](https://docs.claude.com/en/docs/claude-code/sub-agents#available-tools) the subagent can use. Inherits all tools if omitted |
| `disallowedTools` | No | Tools to deny, removed from inherited or specified list |
| `model` | No | [Model](https://docs.claude.com/en/docs/claude-code/sub-agents#choose-a-model) to use: `sonnet`, `opus`, `haiku`, a full model ID (for example, `claude-opus-4-7`), or `inherit`. Defaults to `inherit` |
| `permissionMode` | No | [Permission mode](https://docs.claude.com/en/docs/claude-code/sub-agents#permission-modes): `default`, `acceptEdits`, `auto`, `dontAsk`, `bypassPermissions`, or `plan` |
| `maxTurns` | No | Maximum number of agentic turns before the subagent stops |
| `skills` | No | [Skills](https://docs.claude.com/docs/en/skills) to load into the subagent’s context at startup. The full skill content is injected, not just made available for invocation. Subagents don’t inherit skills from the parent conversation |
...
| `hooks` | No | [Lifecycle hooks](https://docs.claude.com/en/docs/claude-code/sub-agents#define-hooks-for-subagents) scoped to this subagent |
| `memory` | No | [Persistent memory scope](https://docs.claude.com/en/docs/claude-code/sub-agents#enable-persistent-memory): `user`, `project`, or `local`. Enables cross-session learning |
| `background` | No | Set to `true` to always run this subagent as a [background task](https://docs.claude.com/en/docs/claude-code/sub-agents#run-subagents-in-foreground-or-background). Default: `false` |
...
| `isolation` | No | Set to `worktree` to run the subagent in a temporary [git worktree](https://docs.claude.com/docs/en/common-workflows#run-parallel-claude-code-sessions-with-git-worktrees), giving it an isolated copy of the repository. The worktree is automatically cleaned up if the subagent makes no changes |
...
| `initialPrompt` | No | Auto-submitted as the first user turn when this agent runs as the main session agent (via `--agent` or the `agent` setting). [Commands](https://docs.claude.com/docs/en/commands) and [skills](https://docs.claude.com/docs/en/skills) are processed. Prepended to any user-provided prompt |

### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#choose-a-model)

Choose a model

The `model` field controls which [AI model](https://docs.claude.com/docs/en/model-config) the subagent uses:
...
1.   The [`CLAUDE_CODE_SUBAGENT_MODEL`](https://docs.claude.com/docs/en/model-config#environment-variables) environment variable, if set
2.   The per-invocation `model` parameter
3.   The subagent definition’s `model` frontmatter
4.   The main conversation’s model

### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#control-subagent-capabilities)
...
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#restrict-which-subagents-can-be-spawned)
...
*   As the main session, launched with [`--agent`](https://docs.claude.com/en/docs/claude-code/sub-agents#invoke-subagents-explicitly) or the `agent` setting

When the agent is the main session, inline server definitions connect at startup alongside servers from [`.mcp.json`](https://docs.claude.com/docs/en/mcp) and settings files.
...
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#permission-modes)
...
| `auto` | [Auto mode](https://docs.claude.com/docs/en/permission-modes#eliminate-prompts-with-auto-mode): a background classifier reviews commands and protected-directory writes |
...
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#preload-skills-into-subagents)
...
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#enable-persistent-memory)
...
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#conditional-rules-with-hooks)
...
Claude Code [passes hook input as JSON](https://docs.claude.com/docs/en/hooks#pretooluse-input) via stdin to hook commands. The validation script reads this JSON, extracts the Bash command, and [exits with code 2](https://docs.claude.com/docs/en/hooks#exit-code-2-behavior-per-event) to block write operations:
...
See [Hook input](https://docs.claude.com/docs/en/hooks#pretooluse-input) for the complete input schema and [exit codes](https://docs.claude.com/docs/en/hooks#exit-code-output) for how exit codes affect behavior.
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#disable-specific-subagents)

Disable specific subagents

You can prevent Claude from using specific subagents by adding them to the `deny` array in your [settings](https://docs.claude.com/docs/en/settings#permission-settings). Use the format `Agent(subagent-name)` where `subagent-name` matches the subagent’s name field.
...
See [Permissions documentation](https://docs.claude.com/docs/en/permissions#tool-specific-permission-rules) for more details on permission rules.
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#define-hooks-for-subagents)

Define hooks for subagents

Subagents can define [hooks](https://docs.claude.com/docs/en/hooks) that run during the subagent’s lifecycle. There are two ways to configure hooks:
...
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#hooks-in-subagent-frontmatter)

Hooks in subagent frontmatter

Define hooks directly in the subagent’s markdown file. These hooks only run while that specific subagent is active and are cleaned up when it finishes.

Frontmatter hooks fire when the agent is spawned as a subagent through the Agent tool or an @-mention, and when the agent runs as the main session via [`--agent`](https://docs.claude.com/en/docs/claude-code/sub-agents#invoke-subagents-explicitly) or the `agent` setting. In the main-session case they run alongside any hooks defined in [`settings.json`](https://docs.claude.com/docs/en/hooks).

All [hook events](https://docs.claude.com/docs/en/hooks#hook-events) are supported. The most common events for subagents are:
...
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#project-level-hooks-for-subagent-events)
...
See [Hooks](https://docs.claude.com/docs/en/hooks) for the complete hook configuration format.
## [​](https://docs.claude.com/en/docs/claude-code/sub-agents#work-with-subagents)

Work with subagents

### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#understand-automatic-delegation)
...
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#invoke-subagents-explicitly)
...
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#run-subagents-in-foreground-or-background)

Run subagents in foreground or background

Subagents can run in the foreground (blocking) or background (concurrent):
*   **Foreground subagents** block the main conversation until complete. Permission prompts and clarifying questions (like [`AskUserQuestion`](https://docs.claude.com/docs/en/tools-reference)) are passed through to you.
...
To disable all background task functionality, set the `CLAUDE_CODE_DISABLE_BACKGROUND_TASKS` environment variable to `1`. See [Environment variables](https://docs.claude.com/docs/en/env-vars).When [fork mode](https://docs.claude.com/en/docs/claude-code/sub-agents#fork-the-current-conversation) is enabled, every subagent spawn runs in the background regardless of the `background` field. Forks still surface permission prompts in your terminal as they occur instead of pre-approving; named subagents follow the pre-approval flow above.
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#common-patterns)

Common patterns

#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#isolate-high-volume-operations)
...
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#run-parallel-research)
...
For tasks that need sustained parallelism or exceed your context window, [agent teams](https://docs.claude.com/docs/en/agent-teams) give each worker its own independent context.
#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#chain-subagents)
...
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#choose-between-subagents-and-main-conversation)
...
Consider [Skills](https://docs.claude.com/docs/en/skills) instead when you want reusable prompts or workflows that run in the main conversation context rather than isolated subagent context.For a quick question about something already in your conversation, use [`/btw`](https://docs.claude.com/docs/en/interactive-mode#side-questions-with-%2Fbtw) instead of a subagent. It sees your full context but has no tool access, and the answer is discarded rather than added to history.

Subagents cannot spawn other subagents. If your workflow requires nested delegation, use [Skills](https://docs.claude.com/docs/en/skills) or [chain subagents](https://docs.claude.com/en/docs/claude-code/sub-agents#chain-subagents) from the main conversation.

### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#manage-subagent-context)

Manage subagent context

#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#resume-subagents)

Resume subagents

Each subagent invocation creates a new instance with fresh context. To continue an existing subagent’s work instead of starting over, ask Claude to resume it.Resumed subagents retain their full conversation history, including all previous tool calls, results, and reasoning. The subagent picks up exactly where it stopped rather than starting fresh.When a subagent completes, Claude receives its agent ID. Claude uses the `SendMessage` tool with the agent’s ID as the `to` field to resume it. The `SendMessage` tool is only available when [agent teams](https://docs.claude.com/docs/en/agent-teams) are enabled via `CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1`.To resume a subagent, ask Claude to continue the previous work:
...
*   **Session persistence**: Subagent transcripts persist within their session. You can [resume a subagent](https://docs.claude.com/en/docs/claude-code/sub-agents#resume-subagents) after restarting Claude Code by resuming the same session.
*   **Automatic cleanup**: Transcripts are cleaned up based on the `cleanupPeriodDays` setting (default: 30 days).

#### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#auto-compaction)
...
## [​](https://docs.claude.com/en/docs/claude-code/sub-agents#fork-the-current-conversation)

Fork the current conversation

Forked subagents are experimental and require Claude Code v2.1.117 or later. Behavior and configuration may change in future releases. Enable them by setting the [`CLAUDE_CODE_FORK_SUBAGENT`](https://docs.claude.com/docs/en/env-vars) environment variable to `1`.
...
*   Claude spawns a fork whenever it would otherwise use the [general-purpose](https://docs.claude.com/en/docs/claude-code/sub-agents#built-in-subagents) subagent. Named subagents such as Explore still spawn as before.
*   Every subagent spawn runs in the [background](https://docs.claude.com/en/docs/claude-code/sub-agents#run-subagents-in-foreground-or-background), whether it is a fork or a named subagent. Set `CLAUDE_CODE_DISABLE_BACKGROUND_TASKS` to `1` to keep spawns synchronous.
*   The `/fork` command spawns a fork instead of acting as an alias for [`/branch`](https://docs.claude.com/docs/en/commands).
...
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#observe-and-steer-running-forks)
...
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#how-forks-differ-from-named-subagents)
...
| System prompt and tools | Same as main session | From the subagent’s [definition file](https://docs.claude.com/en/docs/claude-code/sub-agents#write-subagent-files) |
| Model | Same as main session | From the subagent’s `model` field |
| Permissions | Prompts surface in your terminal | [Pre-approved](https://docs.claude.com/en/docs/claude-code/sub-agents#run-subagents-in-foreground-or-background) before launch, then auto-denied |
...
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#limitations)

Limitations

Fork mode works only in interactive sessions. It is disabled in [non-interactive mode](https://docs.claude.com/docs/en/headless), which includes the Agent SDK. A fork cannot spawn further forks.
...
### [​](https://docs.claude.com/en/docs/claude-code/sub-agents#database-query-validator)
...
The hook receives JSON via stdin with the Bash command in `tool_input.command`. Exit code 2 blocks the operation and feeds the error message back to Claude. See [Hooks](https://docs.claude.com/docs/en/hooks#exit-code-output) for details on exit codes and [Hook input](https://docs.claude.com/docs/en/hooks#pretooluse-input) for the complete input schema.
## [​](https://docs.claude.com/en/docs/claude-code/sub-agents#next-steps)

Next steps

Now that you understand subagents, explore these related features:
*   [Distribute subagents with plugins](https://docs.claude.com/docs/en/plugins) to share subagents across teams or projects
*   [Run Claude Code programmatically](https://docs.claude.com/docs/en/headless) with the Agent SDK for CI/CD and automation
*   [Use MCP servers](https://docs.claude.com/docs/en/mcp) to give subagents access to external tools and data
...
[Privacy choices](https://docs.claude.com/en/docs/claude-code/sub-agents#)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
