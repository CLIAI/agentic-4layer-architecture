<!--
Cached from: https://docs.claude.com/en/docs/claude-code/hooks
Fetch date: 2026-04-24
Fetcher: jina.ai reader proxy (r.jina.ai)
Purpose: L4 Launcher flags + general reference for the 4-layer
         agentic architecture docs. Re-fetch periodically to pick
         up new flags/events — Claude Code docs iterate quickly.
-->

Title: Hooks reference - Claude Code Docs

URL Source: https://docs.claude.com/en/docs/claude-code/hooks

Markdown Content:
# Hooks reference - Claude Code Docs

[Skip to main content](https://docs.claude.com/en/docs/claude-code/hooks#content-area)
...
*   [Commands](https://docs.claude.com/docs/en/commands)
*   [Environment variables](https://docs.claude.com/docs/en/env-vars)
*   [Tools reference](https://docs.claude.com/docs/en/tools-reference)
...
*   [Channels reference](https://docs.claude.com/docs/en/channels-reference)

On this page

*   [Hook lifecycle](https://docs.claude.com/en/docs/claude-code/hooks#hook-lifecycle)
*   [How a hook resolves](https://docs.claude.com/en/docs/claude-code/hooks#how-a-hook-resolves)
*   [Configuration](https://docs.claude.com/en/docs/claude-code/hooks#configuration)
*   [Hook locations](https://docs.claude.com/en/docs/claude-code/hooks#hook-locations)
*   [Matcher patterns](https://docs.claude.com/en/docs/claude-code/hooks#matcher-patterns)
*   [Match MCP tools](https://docs.claude.com/en/docs/claude-code/hooks#match-mcp-tools)
*   [Hook handler fields](https://docs.claude.com/en/docs/claude-code/hooks#hook-handler-fields)
*   [Common fields](https://docs.claude.com/en/docs/claude-code/hooks#common-fields)
*   [Command hook fields](https://docs.claude.com/en/docs/claude-code/hooks#command-hook-fields)
*   [HTTP hook fields](https://docs.claude.com/en/docs/claude-code/hooks#http-hook-fields)
*   [MCP tool hook fields](https://docs.claude.com/en/docs/claude-code/hooks#mcp-tool-hook-fields)
*   [Prompt and agent hook fields](https://docs.claude.com/en/docs/claude-code/hooks#prompt-and-agent-hook-fields)
*   [Reference scripts by path](https://docs.claude.com/en/docs/claude-code/hooks#reference-scripts-by-path)
*   [Hooks in skills and agents](https://docs.claude.com/en/docs/claude-code/hooks#hooks-in-skills-and-agents)
*   [The /hooks menu](https://docs.claude.com/en/docs/claude-code/hooks#the-%2Fhooks-menu)
*   [Disable or remove hooks](https://docs.claude.com/en/docs/claude-code/hooks#disable-or-remove-hooks)
*   [Hook input and output](https://docs.claude.com/en/docs/claude-code/hooks#hook-input-and-output)
*   [Common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields)
*   [Exit code output](https://docs.claude.com/en/docs/claude-code/hooks#exit-code-output)
*   [Exit code 2 behavior per event](https://docs.claude.com/en/docs/claude-code/hooks#exit-code-2-behavior-per-event)
*   [HTTP response handling](https://docs.claude.com/en/docs/claude-code/hooks#http-response-handling)
*   [JSON output](https://docs.claude.com/en/docs/claude-code/hooks#json-output)
*   [Decision control](https://docs.claude.com/en/docs/claude-code/hooks#decision-control)
...
*   [Persist environment variables](https://docs.claude.com/en/docs/claude-code/hooks#persist-environment-variables)
*   [InstructionsLoaded](https://docs.claude.com/en/docs/claude-code/hooks#instructionsloaded)
*   [InstructionsLoaded input](https://docs.claude.com/en/docs/claude-code/hooks#instructionsloaded-input)
*   [InstructionsLoaded decision control](https://docs.claude.com/en/docs/claude-code/hooks#instructionsloaded-decision-control)
...
*   [UserPromptExpansion](https://docs.claude.com/en/docs/claude-code/hooks#userpromptexpansion)
*   [UserPromptExpansion input](https://docs.claude.com/en/docs/claude-code/hooks#userpromptexpansion-input)
*   [UserPromptExpansion decision control](https://docs.claude.com/en/docs/claude-code/hooks#userpromptexpansion-decision-control)
...
*   [Defer a tool call for later](https://docs.claude.com/en/docs/claude-code/hooks#defer-a-tool-call-for-later)
*   [PermissionRequest](https://docs.claude.com/en/docs/claude-code/hooks#permissionrequest)
*   [PermissionRequest input](https://docs.claude.com/en/docs/claude-code/hooks#permissionrequest-input)
*   [PermissionRequest decision control](https://docs.claude.com/en/docs/claude-code/hooks#permissionrequest-decision-control)
*   [Permission update entries](https://docs.claude.com/en/docs/claude-code/hooks#permission-update-entries)
...
*   [PostToolUseFailure](https://docs.claude.com/en/docs/claude-code/hooks#posttoolusefailure)
*   [PostToolUseFailure input](https://docs.claude.com/en/docs/claude-code/hooks#posttoolusefailure-input)
*   [PostToolUseFailure decision control](https://docs.claude.com/en/docs/claude-code/hooks#posttoolusefailure-decision-control)
*   [PostToolBatch](https://docs.claude.com/en/docs/claude-code/hooks#posttoolbatch)
*   [PostToolBatch input](https://docs.claude.com/en/docs/claude-code/hooks#posttoolbatch-input)
*   [PostToolBatch decision control](https://docs.claude.com/en/docs/claude-code/hooks#posttoolbatch-decision-control)
*   [PermissionDenied](https://docs.claude.com/en/docs/claude-code/hooks#permissiondenied)
*   [PermissionDenied input](https://docs.claude.com/en/docs/claude-code/hooks#permissiondenied-input)
*   [PermissionDenied decision control](https://docs.claude.com/en/docs/claude-code/hooks#permissiondenied-decision-control)
...
*   [SubagentStart](https://docs.claude.com/en/docs/claude-code/hooks#subagentstart)
*   [SubagentStart input](https://docs.claude.com/en/docs/claude-code/hooks#subagentstart-input)
*   [SubagentStop](https://docs.claude.com/en/docs/claude-code/hooks#subagentstop)
*   [SubagentStop input](https://docs.claude.com/en/docs/claude-code/hooks#subagentstop-input)
*   [TaskCreated](https://docs.claude.com/en/docs/claude-code/hooks#taskcreated)
*   [TaskCreated input](https://docs.claude.com/en/docs/claude-code/hooks#taskcreated-input)
*   [TaskCreated decision control](https://docs.claude.com/en/docs/claude-code/hooks#taskcreated-decision-control)
*   [TaskCompleted](https://docs.claude.com/en/docs/claude-code/hooks#taskcompleted)
*   [TaskCompleted input](https://docs.claude.com/en/docs/claude-code/hooks#taskcompleted-input)
*   [TaskCompleted decision control](https://docs.claude.com/en/docs/claude-code/hooks#taskcompleted-decision-control)
*   [Stop](https://docs.claude.com/en/docs/claude-code/hooks#stop)
*   [Stop input](https://docs.claude.com/en/docs/claude-code/hooks#stop-input)
*   [Stop decision control](https://docs.claude.com/en/docs/claude-code/hooks#stop-decision-control)
*   [StopFailure](https://docs.claude.com/en/docs/claude-code/hooks#stopfailure)
*   [StopFailure input](https://docs.claude.com/en/docs/claude-code/hooks#stopfailure-input)
*   [TeammateIdle](https://docs.claude.com/en/docs/claude-code/hooks#teammateidle)
*   [TeammateIdle input](https://docs.claude.com/en/docs/claude-code/hooks#teammateidle-input)
*   [TeammateIdle decision control](https://docs.claude.com/en/docs/claude-code/hooks#teammateidle-decision-control)
*   [ConfigChange](https://docs.claude.com/en/docs/claude-code/hooks#configchange)
*   [ConfigChange input](https://docs.claude.com/en/docs/claude-code/hooks#configchange-input)
*   [ConfigChange decision control](https://docs.claude.com/en/docs/claude-code/hooks#configchange-decision-control)
*   [CwdChanged](https://docs.claude.com/en/docs/claude-code/hooks#cwdchanged)
*   [CwdChanged input](https://docs.claude.com/en/docs/claude-code/hooks#cwdchanged-input)
*   [CwdChanged output](https://docs.claude.com/en/docs/claude-code/hooks#cwdchanged-output)
*   [FileChanged](https://docs.claude.com/en/docs/claude-code/hooks#filechanged)
*   [FileChanged input](https://docs.claude.com/en/docs/claude-code/hooks#filechanged-input)
*   [FileChanged output](https://docs.claude.com/en/docs/claude-code/hooks#filechanged-output)
*   [WorktreeCreate](https://docs.claude.com/en/docs/claude-code/hooks#worktreecreate)
*   [WorktreeCreate input](https://docs.claude.com/en/docs/claude-code/hooks#worktreecreate-input)
*   [WorktreeCreate output](https://docs.claude.com/en/docs/claude-code/hooks#worktreecreate-output)
*   [WorktreeRemove](https://docs.claude.com/en/docs/claude-code/hooks#worktreeremove)
*   [WorktreeRemove input](https://docs.claude.com/en/docs/claude-code/hooks#worktreeremove-input)
...
*   [PostCompact](https://docs.claude.com/en/docs/claude-code/hooks#postcompact)
*   [PostCompact input](https://docs.claude.com/en/docs/claude-code/hooks#postcompact-input)
...
*   [Elicitation](https://docs.claude.com/en/docs/claude-code/hooks#elicitation)
*   [Elicitation input](https://docs.claude.com/en/docs/claude-code/hooks#elicitation-input)
*   [Elicitation output](https://docs.claude.com/en/docs/claude-code/hooks#elicitation-output)
*   [ElicitationResult](https://docs.claude.com/en/docs/claude-code/hooks#elicitationresult)
*   [ElicitationResult input](https://docs.claude.com/en/docs/claude-code/hooks#elicitationresult-input)
*   [ElicitationResult output](https://docs.claude.com/en/docs/claude-code/hooks#elicitationresult-output)
*   [Prompt-based hooks](https://docs.claude.com/en/docs/claude-code/hooks#prompt-based-hooks)
*   [How prompt-based hooks work](https://docs.claude.com/en/docs/claude-code/hooks#how-prompt-based-hooks-work)
*   [Prompt hook configuration](https://docs.claude.com/en/docs/claude-code/hooks#prompt-hook-configuration)
*   [Response schema](https://docs.claude.com/en/docs/claude-code/hooks#response-schema)
*   [Example: Multi-criteria Stop hook](https://docs.claude.com/en/docs/claude-code/hooks#example-multi-criteria-stop-hook)
*   [Agent-based hooks](https://docs.claude.com/en/docs/claude-code/hooks#agent-based-hooks)
*   [How agent hooks work](https://docs.claude.com/en/docs/claude-code/hooks#how-agent-hooks-work)
*   [Agent hook configuration](https://docs.claude.com/en/docs/claude-code/hooks#agent-hook-configuration)
*   [Run hooks in the background](https://docs.claude.com/en/docs/claude-code/hooks#run-hooks-in-the-background)
*   [Configure an async hook](https://docs.claude.com/en/docs/claude-code/hooks#configure-an-async-hook)
*   [How async hooks execute](https://docs.claude.com/en/docs/claude-code/hooks#how-async-hooks-execute)
*   [Example: run tests after file changes](https://docs.claude.com/en/docs/claude-code/hooks#example-run-tests-after-file-changes)
*   [Limitations](https://docs.claude.com/en/docs/claude-code/hooks#limitations)
...
*   [Windows PowerShell tool](https://docs.claude.com/en/docs/claude-code/hooks#windows-powershell-tool)
*   [Debug hooks](https://docs.claude.com/en/docs/claude-code/hooks#debug-hooks)
...
For a quickstart guide with examples, see [Automate workflows with hooks](https://docs.claude.com/docs/en/hooks-guide).
...
## [​](https://docs.claude.com/en/docs/claude-code/hooks#hook-lifecycle)
...
| `TeammateIdle` | When an [agent team](https://docs.claude.com/docs/en/agent-teams) teammate is about to go idle |
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#how-a-hook-resolves)
...
The [Configuration](https://docs.claude.com/en/docs/claude-code/hooks#configuration) section below documents the full schema, and each [hook event](https://docs.claude.com/en/docs/claude-code/hooks#hook-events) section documents what input your command receives and what output it can return.
## [​](https://docs.claude.com/en/docs/claude-code/hooks#configuration)

Configuration

Hooks are defined in JSON settings files. The configuration has three levels of nesting:
1.   Choose a [hook event](https://docs.claude.com/en/docs/claude-code/hooks#hook-events) to respond to, like `PreToolUse` or `Stop`
2.   Add a [matcher group](https://docs.claude.com/en/docs/claude-code/hooks#matcher-patterns) to filter when it fires, like “only for the Bash tool”
3.   Define one or more [hook handlers](https://docs.claude.com/en/docs/claude-code/hooks#hook-handler-fields) to run when matched

See [How a hook resolves](https://docs.claude.com/en/docs/claude-code/hooks#how-a-hook-resolves) above for a complete walkthrough with an annotated example.
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#hook-locations)
...
| [Plugin](https://docs.claude.com/docs/en/plugins)`hooks/hooks.json` | When plugin is enabled | Yes, bundled with the plugin |
| [Skill](https://docs.claude.com/docs/en/skills) or [agent](https://docs.claude.com/docs/en/sub-agents) frontmatter | While the component is active | Yes, defined in the component file |
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#matcher-patterns)
...
The `FileChanged` event does not follow these rules when building its watch list. See [FileChanged](https://docs.claude.com/en/docs/claude-code/hooks#filechanged).Each event type matches on a different field:
...
| `FileChanged` | literal filenames to watch (see [FileChanged](https://docs.claude.com/en/docs/claude-code/hooks#filechanged)) | `.envrc|.env` |
...
The matcher runs against a field from the [JSON input](https://docs.claude.com/en/docs/claude-code/hooks#hook-input-and-output) that Claude Code sends to your hook on stdin. For tool events, that field is `tool_name`. Each [hook event](https://docs.claude.com/en/docs/claude-code/hooks#hook-events) section lists the full set of matcher values and the input schema for that event.This example runs a linting script only when Claude writes or edits a file:
...
`UserPromptSubmit`, `PostToolBatch`, `Stop`, `TeammateIdle`, `TaskCreated`, `TaskCompleted`, `WorktreeCreate`, `WorktreeRemove`, and `CwdChanged` don’t support matchers and always fire on every occurrence. If you add a `matcher` field to these events, it is silently ignored.For tool events, you can filter more narrowly by setting the [`if` field](https://docs.claude.com/en/docs/claude-code/hooks#common-fields) on individual hook handlers. `if` uses [permission rule syntax](https://docs.claude.com/docs/en/permissions) to match against the tool name and arguments together, so `"Bash(git *)"` runs when any subcommand of the Bash input matches `git *` and `"Edit(*.ts)"` runs only for TypeScript files.
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#match-mcp-tools)

Match MCP tools

[MCP](https://docs.claude.com/docs/en/mcp) server tools appear as regular tools in tool events (`PreToolUse`, `PostToolUse`, `PostToolUseFailure`, `PermissionRequest`, `PermissionDenied`), so you can match them the same way you match any other tool name.MCP tools follow the naming pattern `mcp__<server>__<tool>`, for example:
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#hook-handler-fields)
...
*   **[Command hooks](https://docs.claude.com/en/docs/claude-code/hooks#command-hook-fields)** (`type: "command"`): run a shell command. Your script receives the event’s [JSON input](https://docs.claude.com/en/docs/claude-code/hooks#hook-input-and-output) on stdin and communicates results back through exit codes and stdout.
*   **[HTTP hooks](https://docs.claude.com/en/docs/claude-code/hooks#http-hook-fields)** (`type: "http"`): send the event’s JSON input as an HTTP POST request to a URL. The endpoint communicates results back through the response body using the same [JSON output format](https://docs.claude.com/en/docs/claude-code/hooks#json-output) as command hooks.
*   **[MCP tool hooks](https://docs.claude.com/en/docs/claude-code/hooks#mcp-tool-hook-fields)** (`type: "mcp_tool"`): call a tool on an already-connected [MCP server](https://docs.claude.com/docs/en/mcp). The tool’s text output is treated like command-hook stdout.
*   **[Prompt hooks](https://docs.claude.com/en/docs/claude-code/hooks#prompt-and-agent-hook-fields)** (`type: "prompt"`): send a prompt to a Claude model for single-turn evaluation. The model returns a yes/no decision as JSON. See [Prompt-based hooks](https://docs.claude.com/en/docs/claude-code/hooks#prompt-based-hooks).
*   **[Agent hooks](https://docs.claude.com/en/docs/claude-code/hooks#prompt-and-agent-hook-fields)** (`type: "agent"`): spawn a subagent that can use tools like Read, Grep, and Glob to verify conditions before returning a decision. Agent hooks are experimental and may change. See [Agent-based hooks](https://docs.claude.com/en/docs/claude-code/hooks#agent-based-hooks).

#### [​](https://docs.claude.com/en/docs/claude-code/hooks#common-fields)
...
| `once` | no | If `true`, runs once per session then is removed. Only honored for hooks declared in [skill frontmatter](https://docs.claude.com/en/docs/claude-code/hooks#hooks-in-skills-and-agents); ignored in settings files and agent frontmatter |
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#command-hook-fields)

Command hook fields

In addition to the [common fields](https://docs.claude.com/en/docs/claude-code/hooks#common-fields), command hooks accept these fields:

| Field | Required | Description |
| --- | --- | --- |
| `command` | yes | Shell command to execute |
| `async` | no | If `true`, runs in the background without blocking. See [Run hooks in the background](https://docs.claude.com/en/docs/claude-code/hooks#run-hooks-in-the-background) |
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#http-hook-fields)

HTTP hook fields

In addition to the [common fields](https://docs.claude.com/en/docs/claude-code/hooks#common-fields), HTTP hooks accept these fields:
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#mcp-tool-hook-fields)

MCP tool hook fields

In addition to the [common fields](https://docs.claude.com/en/docs/claude-code/hooks#common-fields), MCP tool hooks accept these fields:
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#prompt-and-agent-hook-fields)

Prompt and agent hook fields

In addition to the [common fields](https://docs.claude.com/en/docs/claude-code/hooks#common-fields), prompt and agent hooks accept these fields:
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#reference-scripts-by-path)
...
*   `${CLAUDE_PLUGIN_ROOT}`: the plugin’s installation directory, for scripts bundled with a [plugin](https://docs.claude.com/docs/en/plugins). Changes on each plugin update.
*   `${CLAUDE_PLUGIN_DATA}`: the plugin’s [persistent data directory](https://docs.claude.com/docs/en/plugins-reference#persistent-data-directory), for dependencies and state that should survive plugin updates.
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#the-/hooks-menu)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#disable-or-remove-hooks)
...
## [​](https://docs.claude.com/en/docs/claude-code/hooks#hook-input-and-output)

Hook input and output

Command hooks receive JSON data via stdin and communicate results through exit codes, stdout, and stderr. HTTP hooks receive the same JSON as the POST request body and communicate results through the HTTP response body. This section covers fields and behavior common to all events. Each event’s section under [Hook events](https://docs.claude.com/en/docs/claude-code/hooks#hook-events) includes its specific input schema and decision control options.
### [​](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields)

Common input fields

Hook events receive these fields as JSON, in addition to event-specific fields documented in each [hook event](https://docs.claude.com/en/docs/claude-code/hooks#hook-events) section. For command hooks, this JSON arrives via stdin. For HTTP hooks, it arrives as the POST request body.
...
| `permission_mode` | Current [permission mode](https://docs.claude.com/docs/en/permissions#permission-modes): `"default"`, `"plan"`, `"acceptEdits"`, `"auto"`, `"dontAsk"`, or `"bypassPermissions"`. Not all events receive this field: see each event’s JSON example below to check |
...
The `tool_name` and `tool_input` fields are event-specific. Each [hook event](https://docs.claude.com/en/docs/claude-code/hooks#hook-events) section documents the additional fields for that event.
### [​](https://docs.claude.com/en/docs/claude-code/hooks#exit-code-output)

Exit code output

The exit code from your hook command tells Claude Code whether the action should proceed, be blocked, or be ignored.**Exit 0** means success. Claude Code parses stdout for [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output). JSON output is only processed on exit 0. For most events, stdout is written to the debug log but not shown in the transcript. The exceptions are `UserPromptSubmit`, `UserPromptExpansion`, and `SessionStart`, where stdout is added as context that Claude can see and act on.**Exit 2** means a blocking error. Claude Code ignores stdout and any JSON in it. Instead, stderr text is fed back to Claude as an error message. The effect depends on the event: `PreToolUse` blocks the tool call, `UserPromptSubmit` rejects the prompt, and so on. See [exit code 2 behavior](https://docs.claude.com/en/docs/claude-code/hooks#exit-code-2-behavior-per-event) for the full list.**Any other exit code** is a non-blocking error for most hook events. The transcript shows a `<hook name> hook error` notice followed by the first line of stderr, so you can identify the cause without `--debug`. Execution continues and the full stderr is written to the debug log.For example, a hook command script that blocks dangerous Bash commands:
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#exit-code-2-behavior-per-event)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#http-response-handling)
...
*   **2xx with a JSON body**: success, parsed using the same [JSON output](https://docs.claude.com/en/docs/claude-code/hooks#json-output) schema as command hooks
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#decision-control)
...
Uses `hookSpecificOutput` for richer control: allow, deny, or escalate to the user. You can also modify tool input before it runs or inject additional context for Claude. See [PreToolUse decision control](https://docs.claude.com/en/docs/claude-code/hooks#pretooluse-decision-control) for the full set of options.
...
In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), SessionStart hooks receive `source`, `model`, and optionally `agent_type`. The `source` field indicates how the session started: `"startup"` for new sessions, `"resume"` for resumed sessions, `"clear"` after `/clear`, or `"compact"` after compaction. The `model` field contains the model identifier. If you start Claude Code with `claude --agent <name>`, an `agent_type` field contains the agent name.
...
Any text your hook script prints to stdout is added as context for Claude. In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, you can return these event-specific fields:
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#persist-environment-variables)
...
`CLAUDE_ENV_FILE` is available for SessionStart, [CwdChanged](https://docs.claude.com/en/docs/claude-code/hooks#cwdchanged), and [FileChanged](https://docs.claude.com/en/docs/claude-code/hooks#filechanged) hooks. Other hook types do not have access to this variable.

### [​](https://docs.claude.com/en/docs/claude-code/hooks#instructionsloaded)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#instructionsloaded-input)

InstructionsLoaded input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), InstructionsLoaded hooks receive these fields:
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#instructionsloaded-decision-control)
...
In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), UserPromptSubmit hooks receive the `prompt` field containing the text the user submitted.
...
`UserPromptSubmit` hooks can control whether a user prompt is processed and add context. All [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) are available.There are two ways to add context to the conversation on exit code 0:
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#userpromptexpansion)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#userpromptexpansion-input)

UserPromptExpansion input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), UserPromptExpansion hooks receive `expansion_type`, `command_name`, `command_args`, `command_source`, and the original `prompt` string. The `expansion_type` field is `slash_command` for skill and custom commands, or `mcp_prompt` for MCP server prompts.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#userpromptexpansion-decision-control)

UserPromptExpansion decision control

`UserPromptExpansion` hooks can block the expansion or add context. All [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) are available.
...
Spawns a [subagent](https://docs.claude.com/docs/en/sub-agents).
...
| Field | Description |
| --- | --- |
| `permissionDecision` | `"allow"` skips the permission prompt. `"deny"` prevents the tool call. `"ask"` prompts the user to confirm. `"defer"` exits gracefully so the tool can be resumed later. [Deny and ask rules](https://docs.claude.com/docs/en/permissions#manage-permissions) are still evaluated regardless of what the hook returns |
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#permissionrequest)

PermissionRequest

Runs when the user is shown a permission dialog. Use [PermissionRequest decision control](https://docs.claude.com/en/docs/claude-code/hooks#permissionrequest-decision-control) to allow or deny on behalf of the user.Matches on tool name, same values as PreToolUse.
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#permissionrequest-input)
...
`PermissionRequest` hooks can allow or deny permission requests. In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, your hook script can return a `decision` object with these event-specific fields:

| Field | Description |
| --- | --- |
| `behavior` | `"allow"` grants the permission, `"deny"` denies it. [Deny and ask rules](https://docs.claude.com/docs/en/permissions#manage-permissions) are still evaluated, so a hook returning `"allow"` does not override a matching deny rule |
...
| `updatedPermissions` | For `"allow"` only: array of [permission update entries](https://docs.claude.com/en/docs/claude-code/hooks#permission-update-entries) to apply, such as adding an allow rule or changing the session permission mode |
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#permission-update-entries)

Permission update entries

The `updatedPermissions` output field and the [`permission_suggestions` input field](https://docs.claude.com/en/docs/claude-code/hooks#permissionrequest-input) both use the same array of entry objects. Each entry has a `type` that determines its other fields, and a `destination` that controls where the change is written.
...
`PostToolUse` hooks can provide feedback to Claude after tool execution. In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, your hook script can return these event-specific fields:
...
| `updatedMCPToolOutput` | For [MCP tools](https://docs.claude.com/en/docs/claude-code/hooks#match-mcp-tools) only: replaces the tool’s output with the provided value |
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#posttoolusefailure)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#posttoolusefailure-input)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#posttoolusefailure-decision-control)

PostToolUseFailure decision control

`PostToolUseFailure` hooks can provide context to Claude after a tool failure. In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, your hook script can return these event-specific fields:
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#posttoolbatch)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#posttoolbatch-input)

PostToolBatch input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), PostToolBatch hooks receive `tool_calls`, an array describing every tool call in the batch:
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#posttoolbatch-decision-control)

PostToolBatch decision control

`PostToolBatch` hooks can inject context for Claude. In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, your hook script can return these event-specific fields:
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#permissiondenied)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#permissiondenied-input)

PermissionDenied input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), PermissionDenied hooks receive `tool_name`, `tool_input`, `tool_use_id`, and `reason`.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#permissiondenied-decision-control)
...
In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), Notification hooks receive `message` with the notification text, an optional `title`, and `notification_type` indicating which type fired.
...
Notification hooks cannot block or modify notifications. In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, you can return `additionalContext` to add context to the conversation:

| Field | Description |
| --- | --- |
| `additionalContext` | String added to Claude’s context |

### [​](https://docs.claude.com/en/docs/claude-code/hooks#subagentstart)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#subagentstart-input)

SubagentStart input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), SubagentStart hooks receive `agent_id` with the unique identifier for the subagent and `agent_type` with the agent name (built-in agents like `"Bash"`, `"Explore"`, `"Plan"`, or custom agent names).
...
SubagentStart hooks cannot block subagent creation, but they can inject context into the subagent. In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, you can return:
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#subagentstop-input)

SubagentStop input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), SubagentStop hooks receive `stop_hook_active`, `agent_id`, `agent_type`, `agent_transcript_path`, and `last_assistant_message`. The `agent_type` field is the value used for matcher filtering. The `transcript_path` is the main session’s transcript, while `agent_transcript_path` is the subagent’s own transcript stored in a nested `subagents/` folder. The `last_assistant_message` field contains the text content of the subagent’s final response, so hooks can access it without parsing the transcript file.
...
SubagentStop hooks use the same decision control format as [Stop hooks](https://docs.claude.com/en/docs/claude-code/hooks#stop-decision-control).
### [​](https://docs.claude.com/en/docs/claude-code/hooks#taskcreated)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#taskcreated-input)

TaskCreated input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), TaskCreated hooks receive `task_id`, `task_subject`, and optionally `task_description`, `teammate_name`, and `team_name`.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#taskcreated-decision-control)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#taskcompleted)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#taskcompleted-input)

TaskCompleted input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), TaskCompleted hooks receive `task_id`, `task_subject`, and optionally `task_description`, `teammate_name`, and `team_name`.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#taskcompleted-decision-control)
...
Runs when the main Claude Code agent has finished responding. Does not run if the stoppage occurred due to a user interrupt. API errors fire [StopFailure](https://docs.claude.com/en/docs/claude-code/hooks#stopfailure) instead.
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#stop-input)

Stop input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), Stop hooks receive `stop_hook_active` and `last_assistant_message`. The `stop_hook_active` field is `true` when Claude Code is already continuing as a result of a stop hook. Check this value or process the transcript to prevent Claude Code from running indefinitely. The `last_assistant_message` field contains the text content of Claude’s final response, so hooks can access it without parsing the transcript file.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#stop-decision-control)

Stop decision control

`Stop` and `SubagentStop` hooks can control whether Claude continues. In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, your hook script can return these event-specific fields:
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#stopfailure)

StopFailure

Runs instead of [Stop](https://docs.claude.com/en/docs/claude-code/hooks#stop) when the turn ends due to an API error. Output and exit code are ignored. Use this to log failures, send alerts, or take recovery actions when Claude cannot complete a response due to rate limits, authentication problems, or other API errors.
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#stopfailure-input)

StopFailure input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), StopFailure hooks receive `error`, optional `error_details`, and optional `last_assistant_message`. The `error` field identifies the error type and is used for matcher filtering.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#teammateidle-decision-control)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#configchange)
...
In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), ConfigChange hooks receive `source` and optionally `file_path`. The `source` field indicates which configuration type changed, and `file_path` provides the path to the specific file that was modified.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#configchange-decision-control)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#cwdchanged-output)

CwdChanged output

In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, CwdChanged hooks can return `watchPaths` to dynamically set which file paths [FileChanged](https://docs.claude.com/en/docs/claude-code/hooks#filechanged) watches:
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#filechanged)
...
*   **Filter which hooks run**: when a watched file changes, the same value filters which hook groups run using the standard [matcher rules](https://docs.claude.com/en/docs/claude-code/hooks#matcher-patterns) against the changed file’s basename.

FileChanged hooks have access to `CLAUDE_ENV_FILE`. Variables written to that file persist into subsequent Bash commands for the session, just as in [SessionStart hooks](https://docs.claude.com/en/docs/claude-code/hooks#persist-environment-variables).
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#filechanged-input)

FileChanged input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), FileChanged hooks receive `file_path` and `event`.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#filechanged-output)

FileChanged output

In addition to the [JSON output fields](https://docs.claude.com/en/docs/claude-code/hooks#json-output) available to all hooks, FileChanged hooks can return `watchPaths` to dynamically update which file paths are watched:
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#worktreecreate-input)

WorktreeCreate input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), WorktreeCreate hooks receive the `name` field. This is a slug identifier for the new worktree, either specified by the user or auto-generated (for example, `bold-oak-a3f2`).
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#worktreecreate-output)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#worktreeremove-input)

WorktreeRemove input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), WorktreeRemove hooks receive the `worktree_path` field, which is the absolute path to the worktree being removed.
...
In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), PreCompact hooks receive `trigger` and `custom_instructions`. For `manual`, `custom_instructions` contains what the user passes into `/compact`. For `auto`, `custom_instructions` is empty.
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#postcompact)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#postcompact-input)

PostCompact input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), PostCompact hooks receive `trigger` and `compact_summary`. The `compact_summary` field contains the conversation summary generated by the compact operation.
...
In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), SessionEnd hooks receive a `reason` field indicating why the session ended. See the [reason table](https://docs.claude.com/en/docs/claude-code/hooks#sessionend) above for all values.
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#elicitation)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#elicitation-input)

Elicitation input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), Elicitation hooks receive `mcp_server_name`, `message`, and optional `mode`, `url`, `elicitation_id`, and `requested_schema` fields.For form-mode elicitation (the most common case):
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#elicitation-output)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#elicitationresult)
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#elicitationresult-input)

ElicitationResult input

In addition to the [common input fields](https://docs.claude.com/en/docs/claude-code/hooks#common-input-fields), ElicitationResult hooks receive `mcp_server_name`, `action`, and optional `mode`, `elicitation_id`, and `content` fields.
...
#### [​](https://docs.claude.com/en/docs/claude-code/hooks#elicitationresult-output)
...
## [​](https://docs.claude.com/en/docs/claude-code/hooks#prompt-based-hooks)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#how-prompt-based-hooks-work)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#prompt-hook-configuration)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#response-schema)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#example-multi-criteria-stop-hook)
...
## [​](https://docs.claude.com/en/docs/claude-code/hooks#agent-based-hooks)

Agent-based hooks

Agent hooks are experimental. Behavior and configuration may change in future releases. For production workflows, prefer [command hooks](https://docs.claude.com/en/docs/claude-code/hooks#command-hook-fields).
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#how-agent-hooks-work)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#agent-hook-configuration)

Agent hook configuration

Set `type` to `"agent"` and provide a `prompt` string. The configuration fields are the same as [prompt hooks](https://docs.claude.com/en/docs/claude-code/hooks#prompt-hook-configuration), with a longer default timeout:
...
## [​](https://docs.claude.com/en/docs/claude-code/hooks#run-hooks-in-the-background)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#configure-an-async-hook)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#how-async-hooks-execute)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#example-run-tests-after-file-changes)
...
### [​](https://docs.claude.com/en/docs/claude-code/hooks#limitations)
...
## [​](https://docs.claude.com/en/docs/claude-code/hooks#windows-powershell-tool)
...
## [​](https://docs.claude.com/en/docs/claude-code/hooks#debug-hooks)
...
For more granular hook matching details, set `CLAUDE_CODE_DEBUG_LOG_LEVEL=verbose` to see additional log lines such as hook matcher counts and query matching.For troubleshooting common issues like hooks not firing, infinite Stop hook loops, or configuration errors, see [Limitations and troubleshooting](https://docs.claude.com/docs/en/hooks-guide#limitations-and-troubleshooting) in the guide. For a broader diagnostic walkthrough covering `/context`, `/doctor`, and settings precedence, see [Debug your config](https://docs.claude.com/docs/en/debug-your-config).

Was this page helpful?

Yes No

[Checkpointing](https://docs.claude.com/docs/en/checkpointing)[Plugins reference](https://docs.claude.com/docs/en/plugins-reference)

⌘I

[Claude Code Docs home page![Image 6: light logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/light.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=78fd01ff4f4340295a4f66e2ea54903c)![Image 7: dark logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/dark.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=1298a0c3b3a1da603b190d0de0e31712)](https://docs.claude.com/docs/en/overview)
...
[Privacy choices](https://docs.claude.com/en/docs/claude-code/hooks#)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
